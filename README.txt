...
All information for initial data for research is found at the end of this document.  
All changes relevant to this new tidy dataset are immediately below.

The data is from the UCI HAR Dataset using the following files:
